    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        if (CollectionUtils.isNotEmpty(items)) {
            ...
            try{
                ...
                FileSaverDialog fileSaverDialog = FileChooser.chooseSaveFile("导出私钥", project, "pem","key");
                VirtualFileWrapper virtualFileWrapper = fileSaverDialog.save(item.getName());
                if(virtualFileWrapper != null){
                    ...
                    try{
                        ...
                        FileUtil.delete(virtualFile.toNioPath());
                    }
                }
            }catch (Throwable err){
                NotifyUtils.notify("私钥导出失败,错误信息: " + err.getMessage(),project);
